...
<div class="container">	
 <div class="st_p_cntss call_bk">	
  <h3>STEP 2:</h3><p>Watch this short video and complete your application below:</p>
 </div>
</div>
<!---- End Step ----->
...
<div class="container">
	...
	<div class="v_part_liststs opt_in_pg call_bk">
	 <div class="iv-player_responsive_padding" style="padding:60% 0 0 0;position:relative;" data-hash="66bb73485f229">
