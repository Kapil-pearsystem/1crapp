...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <form action="{{ route('leadstore') }}" method="post" enctype="multipart/form-data">
                        @csrf

                        <div class="binng_araes my_proffs" id="full_dbydds">
                            <div class="al_frm_bx" id="company-section">

                                <h5>Company Details</h5>
                                <p>Company details settings in this section are common across lead magnet and raports.
                                </p>
                                ...
                                <div class="row">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="ons_frmss full_widths">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="inp_araea" name="company_name"
                                                                value="Ramjee Enterprises">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="ons_frmss half_widths">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="inp_araea" name="company_email"
                                                                value="incomeplusindia@gmail.com">
                                                            <select class="slt_areaa" name="company_email_type">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="ons_frmss half_widths">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="inp_araea" name="company_phone">
                                                            <select class="slt_areaa" name="company_phone_type">
                                                                <option value="1">Work</option>
                                                            </select>
                                                            <span class="ad_linkss"><a href="javascript:void(0);">+Add
                                                                    Phone</a></span>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="inp_araea" name="company_address"
                                            value="G-01,Green View, Swroop Vihar Vistar, Jagatpura">
                                    </div>

                                    <div class="col-lg-4">
                                        <label>Company Website</label>
                                        <input type="text" class="inp_araea" name="company_website">
                                    </div>

                                    <div class="col-lg-4">
                                        <label>Company Logo</label>
                                        <input type="file" class="inp_araea files" name="company_logo">
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="avatar-upload">
                                            <div class="avatar-preview">
                                                <div id="imagePreview"
                                                    style="background-image:url({{ url('home/img/edtpro.jpg') }});">
                                                </div>
                                            </div>
                                            <div class="avatar-edit lnk_s_bntt">
                                                <!-- <input type="file" id="imageUpload" accept=".png, .jpg, .jpeg" /> -->
                                                <!-- <label for="imageUpload">Save Details</label> -->
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="binng_araes my_proffs" id="full_dbydds">
                            <div class="al_frm_bx tx_sm_sizess">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Header & Footer Background, countdown icon tick color & Download
                                                Arrow</label>
                                            <div class="clr_tx_pickks color-picker" data-name="header_footer_bg_color">
                                                #3345345</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="clr_tx_pickks color-picker" data-name="button_bg_color">#3345345
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="clr_tx_pickks color-picker"
                                                data-name="header_footer_text_color">#3345345</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="clr_tx_pickks color-picker" data-name="button_text_color">
                                                #3345345</div>
                                        </div>
                                    </div>
                    ...
                    <div class="mess_form_fildss mt-0">
                        <div class="link_fildss">
                            <a href="https://1crapp.allproject.online/lead-magnet">Go To Stap</a>
                        </div>
                    </div>
                </div>
    ...
    document.querySelectorAll('.color-picker').forEach(function(box) {
        ...
        box.closest('form').appendChild(input);
        box.closest('form').appendChild(hidden);

        box.addEventListener('click', function() {
            input.value = box.innerText.trim();
            input.click();
        });
