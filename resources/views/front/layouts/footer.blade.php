<style>
  ...
  .usr_likts .urs_bx_rgss .bg_ctxtx {
    font-size: 17px;
    color: #ffe000;
    line-height: 24px;
    font-weight: 700;
  ...
  .usr_likts .urs_bx_rgss .cnt_txt_bx {
    width: 70%;
    color: #fff;
    float: left;
  }
  ...
  .usr_likts .urs_bx_rgss .mg_bx_araeae img {
    width: 100%;
  }

  #ftr_alsss .usr_likts a.dwn_ldss {
    background: #003250;
    display: block;
    padding: 8px;
    color: #fff;
  ...
  <div class="container">
    ...
    <div class="copy_btm">
      <div class="row">
        ...
        <div class="col-lg-4">
          Copyright {{ date('Y') }} <a href="{{ url('') }}">{{ request()->getHost() }}</a> all rights reserved
        </div>
      </div>
    </div>
  </div>
