...
.business_card_items .businnes_main .content_arara .form-group .ck_list_tik p {display: flex;}
.business_card_items .businnes_main .content_arara .form-group .ck_list_tik p input {position: relative; top: -8px; margin-right: 5px;}
.businnes_main .user_proff .social_iconsss ul li a {padding: 5px 11px;}
#chat_mesages iframe {width: 100%;}

.businnes_main .user_proff {padding: 20px 10px;}
.businnes_main .user_proff .user_list ul li span.cntents a.al_linkss {font-size: 14px;}
.businnes_main .user_proff .user_list ul li span.cntents {font-size: 14px;}
.businnes_main .user_proff .user_list ul li span.cntents a {padding: 6px 10px; font-size: 14px;}
    ...
    <div class="container">
        <div class="businnes_main">
            ...
            <div class="content_arara">
                <div class="mettre">
                    <span class="toll_tops"><i class="fa fa-info-circle"></i></span> Your digital business card share link is: <a href="javascript:void(0);">www.newoaks.ai/ramjee</a> <span class="copy_urlss">Copy your share URL</span>
                </div>
                        ...
                        <form action="">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9"><input type="text" name="" value="" class="form-control" placeholder="Enter Name" required="" /></div>
                                </div>
                            </div>
                            <!--- End List Item ---->
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9"><input type="file" name="" value="" required="" /></div>
                                </div>
                            </div>
                            <!--- End List Item ---->
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-5"><input type="text" name="" value="" class="form-control" placeholder="Enter Name" required="" /></div>
                                    <div class="col-lg-4"><input type="text" name="" value="" class="form-control" placeholder="Enter Last Name" required="" /></div>
                                </div>
                            </div>
                            <!--- End List Item ---->
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9"><input type="text" name="" value="" class="form-control" placeholder="Enter Email ID" required="" /></div>
                                </div>
                            </div>
                            <!--- End List Item ---->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9">
									 <select class="form-control">
									  <option value="1">Digital Ramjee Bot</option>
									 </select>
									</div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9"><input type="text" name="" value="" class="form-control" placeholder="Enter Digital Ramjee Bot" /></div>
                                </div>
                            </div>
                            <!--- End List Item ---->
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9"><input type="text" name="" value="" class="form-control" placeholder="Enter Organizations" /></div>
                                </div>
                            </div>
                            <!--- End List Item ---->
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9"><input type="text" name="" value="" class="form-control" id="mobile_code" placeholder="Enter Phone Number" /></div>
                                </div>
                            </div>
                            <!--- End List Item ---->
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9"><input type="text" name="" value="" class="form-control" placeholder="Enter Website URL" /></div>
                                </div>
                            </div>
                            <!--- End List Item ---->
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9"><input type="text" name="" value="" class="form-control" placeholder="Enter Facebook URL" /></div>
                                </div>
                            </div>
                            <!--- End List Item ---->
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9"><input type="text" name="" value="" class="form-control" placeholder="Enter Linkedin URL" /></div>
                                </div>
                            </div>
                            <!--- End List Item ---->
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9"><input type="text" name="" value="" class="form-control" placeholder="Enter WhatsApp URL" /></div>
                                </div>
                            </div>
                            <!--- End List Item ---->
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9"><input type="text" name="" value="" class="form-control" placeholder="Enter Instagram URL" /></div>
                                </div>
                            </div>
                            <!--- End List Item ---->
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9"><input type="text" name="" value="" class="form-control" placeholder="Enter Twitter URL" /></div>
                                </div>
                            </div>
                            <!--- End List Item ---->
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9"><input type="text" name="" value="" class="form-control" placeholder="Enter City" /></div>
                                </div>
                            </div>
                            <!--- End List Item ---->
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9"><input type="text" name="" value="" class="form-control" placeholder="Enter State/Province" /></div>
                                </div>
                            </div>
                            <!--- End List Item ---->
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9"><input type="text" name="" value="" class="form-control" placeholder="Enter Country" /></div>
                                </div>
                            </div>
                            <!--- End List Item ---->
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9"><textarea name="" id="" cols="3" rows="3" class="form-control" placeholder="Enter Message" required=""></textarea></div>
                                </div>
                            </div>
                            <!--- End List Item ---->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="ck_list_tik">
                                            <p>
                                                <input type="checkbox" id="ck_llst" name="ck_llst" value="1" />
                                                <label for="ck_llst"> Pop Up Predefined SMS Upon Scanning</label>
                                            </p>
                                            <p>
                                                <input type="checkbox" id="ck_llst1" name="ck_llst1" value="2" />
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-3"><span class="titalss_name">&nbsp;</span></div>
                                    <div class="col-lg-9">
                                        <div class="sub_miitss">
                                            <button type="submit" value="submit">Save & Preview</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
 jQuery(".click-parts").on("click", function() {
    jQuery(".show_parts_arar").toggleClass("active");
});

jQuery(document).click(function(event) {
    var container = jQuery(".show_parts_arar, .click-parts");
    if (
