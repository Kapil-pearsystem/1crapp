...
<style>
    ...
    .show_parts_arar.active#sld_ara_partss .social_iconsss ul li:last-child {
        margin-right: 0;
    }
    .show_parts_arar.active#sld_ara_partss .qr_images {
        display: inline-block;
    ...
    .show_parts_arar.active#sld_ara_partss .url_cpyss input:focus {
        outline: none;
    }
    .show_parts_arar.active#sld_ara_partss .url_cpyss button:focus {
        outline: none;
    }
    .show_parts_arar.active {
        display: block;
    }
                        ...
                        <div class="col-lg-12">
                            <div class="bus_part_lk newarea">
                                ...
                                <div class="show_parts_arar" id="sld_ara_partss">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a href="javascript:void(0);"
                                                    onclick="copyInstagramShareLink()">
                                                    <i class="fa fa-instagram"></i>
                                                </a>
                                            </li>
                                        </ul>
                                        <script>
                                            function copyInstagramShareLink() {
                                    ...
                                    @endphp
                                    <div class="qr_images">
                                        <div class="qr_mg_area">
                                            <img
                                                src="https://quickchart.io/qr?text={{ urlencode($currentUrl) }}&size=300"
                                                alt="QR Code"
                                                width="400">
                                        </div>
                                        <div class="dwn_led">
                                            <a href="https://quickchart.io/qr?text={{ urlencode($currentUrl) }}&size=300"
                                    ...
                                    <div class="url_cpyss">
                                        <input type="text" value="{{ url()->current() }}" placeholder="Enter URL" />
                                        <button type="button" onclick="copyInstagramShareLink()">
                                    ...
                                    <div class="user_list">
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <span class="cntents">{{ @$card->telephone }} <span class="und_txss">Phone</span></span>
                                            </li>
                                            <li>
                                                <span class="usr_icoos"><i class="fa fa-envelope-o"></i></span>
                                                <span class="cntents"><a href="mailto:{{ @$card->email }}" class="al_linkss">{{ @$card->email }}</a> <span class="und_txss">Email</span></span>
                                            </li>
                                            <li>
                                                <span class="usr_icoos"><i class="fa fa-globe"></i></span>
                                                <span class="cntents">{{ @$card->website }} <span class="und_txss">Official Website</span></span>
                                            </li>
                                            <li>
