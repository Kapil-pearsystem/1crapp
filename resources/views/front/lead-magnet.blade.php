...
.intter_urlls button.btn_sharess:focus {
    outline: none;
}
                        ...
                        <div class="frm_al_suprtsss">
                            <form action="https://1crapp.allproject.online/aa-page">
                                ...
                                <div class="form-group">
                                    <button type="" value="Submit Now" class="btn-submit2">Yes Wisit To Apply
                                        Now!</button>
                                </div>
                            </form>
                        </div>
    ...
    <div class="part_both_arraea">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <form action="{{ route('leadmagnet.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="card-body mt-2" style="background: rgb(190, 218, 253);">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="main_both_boxx">
                                            <div class="in_box_araess mb-2 mt-1 mb-sm-0">
                                                <p>Pre HeadLine</p>
                                                <input type="text" placeholder="Enter Title" name="pre_headline"
                                            ...
                                            <div class="mb-2 mt-1 mb-sm-0 swich_bntts">
                                                ...
                                                <div class="block_araea">
                                                    <label class="switch">
                                                        <input type="checkbox" name="pre_headline_visible" value="1" />
                                                        <small></small>
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="main_both_boxx">
                                            <div class="in_box_araess mb-2 mt-1 mb-sm-0">
                                                <p>HeadLine</p>
                                                <input type="text" placeholder="Enter Title" name="headline"
                                                    class="form-control form-control-user" />
                                            </div>
                                            <div class="mb-2 mt-1 mb-sm-0 swich_bntts">
                                                <p>Visible</p>
                                                <div class="block_araea">
                                                    <label class="switch">
                                                        <input type="checkbox" name="headline_visible" value="1" />
                                                        <small></small>
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-6 mt-4">
                                        <div class="main_both_boxx">
                                            <div class="in_box_araess mb-2 mt-1 mb-sm-0">
                                                <p>Post HeadLine</p>
                                                <input type="text" placeholder="Enter Title" name="post_headline"
                                                    class="form-control form-control-user" />
                                            </div>
                                            <div class="mb-2 mt-1 mb-sm-0 swich_bntts">
                                                <p>Visible</p>
                                                <div class="block_araea">
                                                    <label class="switch">
                                                        <input type="checkbox" name="post_headline_visible" value="1" />
                                                        <small></small>
                                                    </label>
                                                </div>
                                            </div>
                            ...
                            <div id="brd_box" class="form-group row">
                                <div class="row">
                                    @for ($i = 1; $i <= 6; $i++) <div class="col-lg-4 mt-{{ $i > 3 ? '3' : '0' }}">
                                        <div class="main_both_boxx">
                                            <div class="in_box_araess full_wdth mb-2 mt-1 mb-sm-0">
                                                <p>Bullet{{ $i }}</p>
                                                <input type="text" placeholder="Enter Bullet{{ $i }}"
                                                    name="bullet{{ $i }}" class="form-control form-control-user" />
                                            </div>
                                        </div>
                                </div>
                                @endfor
                                ...
                                <div class="col-lg-12 mt-4">
                                    <div class="main_both_boxx">
                                        <div class="mb-2 mt-1 mb-sm-0 swich_bntts">
                                            ...
                                            <div class="block_araea">
                                                <label class="switch">
                                                    <input type="checkbox" name="bullet_status" value="1" />
                                                    <small></small>
                                                </label>
                                            </div>
                                        </div>
                        ...
                        <div id="brd_box" class="form-group row">
                            <div class="col-lg-6">
                                <div class="main_both_boxx">
                                    <p>Media Type</p>
                                    <select name="media_type" required class="form-control">
                                    ...
                                    <div class="col-sm-3 mb-2 mt-1 mb-sm-0 swich_bntts">
                                        ...
                                        <div class="block_araea mt-1">
                                            <label class="switch">
                                                <input type="checkbox" name="media_visible" value="1" /> <small></small>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-12 mt-3">
                                <div class="main_both_boxx">
                                    ...
                                    <input type="date" name="countdown_datetime"
                                        class="form-control form-control-user" />
                                    <div class="col-sm-3 mb-2 mt-1 mb-sm-0 swich_bntts">
                                        <p>Visible</p>
                                        <div class="block_araea mt-1">
                                            <label class="switch">
                                                <input type="checkbox" name="countdown_visible" value="1" />
                                                <small></small>
                                            </label>
                                        </div>
                                    </div>
                        ...
                        <div id="brd_box" class="form-group row">
                            <div class="col-lg-6">
                                <div class="main_both_boxx">
                                    <p>Pre CTA</p>
                                    <input type="text" name="pre_cta" class="form-control form-control-user" />
                                    <div class="mb-2 mt-1 mb-sm-0 swich_bntts">
                                        <p>Visible</p>
                                        <div class="block_araea">
                                            <label class="switch">
                                                <input type="checkbox" name="pre_cta_visible" value="1" />
                                                <small></small>
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="main_both_boxx">
                                    <p>PS Text</p>
                                    <input type="text" name="ps_text" class="form-control form-control-user" />
                                    <div class="mb-2 mt-1 mb-sm-0 swich_bntts">
                                        <p>Visible</p>
                                        <div class="block_araea">
                                            <label class="switch">
                                                <input type="checkbox" name="ps_text_visible" value="1" />
                                                <small></small>
                                            </label>
                                        </div>
                                    </div>
                        ...
                        <div id="brd_box" class="form-group row">
                            <div class="col-lg-3">
                                <div class="main_both_boxx">
                                    <div class="mb-2 mt-1 mb-sm-0 swich_bntts full_wdth">
                                        ...
                                        <div class="block_araea">
                                            <label class="switch">
                                                <input type="checkbox" name="popup_enable" value="1" /> <small></small>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-8">
                                <div class="main_both_boxx">
                                    <p>Page CTA URL</p>
                                    <input type="text" name="page_cta_url" class="form-control form-control-user" />
                                    <div class="mb-2 mt-1 mb-sm-0 swich_bntts">
                                        <p>Visible</p>
                                        <div class="block_araea">
                                            <label class="switch">
                                                <input type="checkbox" name="page_cta_url_visible" value="1" />
                                                <small></small>
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-12 mt-4">
                                <div class="main_both_boxx">
                                    <p>Enter CTA URL</p>
                                    <input type="text" name="enter_cta_url" class="form-control form-control-user" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="brd_box" class="form-group row">
                            <div class="col-lg-12">
                                <div class="main_both_boxx">
                                    <p>CTA Title</p>
                                    <input type="text" name="cta_title" class="form-control form-control-user"
                                        placeholder="ACCESS the 1CR APP Now" />
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="mess_form_fildss">
                    <p>Unfortunately you do not have branding option, Upgrade now or get in touch with us <a
                            href="javascript:void(0);">Upgraed Now</a></p>
                    <div class="link_fildss">
                        <button type="submit">Generate the Leadmagnet</button>
                        <!-- <button type="submit"><a href="https://1crapp.allproject.online/lead-magnet1">Generate the Leadmagnet</a></button> -->
                    </div>
                </div>
            ...
            <div class="col-lg-6">
                            ...
                            <div class="row">
                                <div class="col-lg-2 col-2">
                                    <div class="othr_logges">
                                        <a class="nav-brand" href="javascript:void(0);"><img class="logo"
                                                src="{{ url('home/img/logo 1.png')}}" alt="Logo" /></a>
                                    </div>
                                </div>
                                <div class="col-lg-10 col-10">
                                    <div class="top_sec_menu cnt_parts">
                                        <ul>
                                            <li>
                                                <a href="{{ url('help') }}"><i class="fa fa-phone"></i> <span>Help
                                                        ?</span></a>
                                            </li>
                                            <li class="callss"><i class="fa fa-whatsapp"></i>
                                                <span>+91-9966680133</span>
                                            </li>
                ...
                <div class="New-On-Demand">
                    <div class="new_ar_tring mt_50p">
                        <h2 class="bnt_rundds"><strong>New On-Demand Training</strong> For Coaches And Consultants
                            And Course Creators!</h2>
                        <h3>Introducing The 1CR APP Content Engine.</h3>
                        <p>"Watch Me Create an entire premium course (modules, content, slides) and marketing system
                            (messaging, audience, pricing, lead magnets, email sequences, pages and more) in
                            minutes!"</p>
                    </div>
                </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-6">
                            <div class="v_part_liststs">
                                <ul>
                                    <li><i class="fa fa-check"></i> The <strong>27 emails</strong> I sent during my
                                        live launch that brought in <strong>$100k in revenue.</strong></li>
                                    <li><i class="fa fa-check"></i> The <strong>27 emails</strong> I sent during my
                                        live launch that brought in <strong>$100k in revenue.</strong></li>
                                    <li><i class="fa fa-check"></i> The <strong>27 emails</strong> I sent during my
                                        live launch that brought in <strong>$100k in revenue.</strong></li>
                        ...
                        <div class="col-lg-12">
                            <div class="v_part_liststs">
                                ...
                                <div class="tx_v_ars">Lorem Ipsum is simply dummy text of the printing and
                ...
                <section class="ftr_new_other">
                    <div class="frt_partsss">
                        <div class="ftr_content">
                            <div class="lgo">
                                <a href="javascript:void(0);"><img class="logo" src="{{ url('home/img/logo 1.png')}}"
                                        alt="Logo" /></a>
                            </div>
                            ...
                            <div class="crt_arar mt-0 mb-4">
                                1CR App : Creating Your Own Lead Magnet is Easy & Fast Now With 1CR App. Try Il It's
                ...
                <div class="intter_urlls">
                    <input type="text" placeholder="htttp://xdsfsdasdasasassdasdas"
