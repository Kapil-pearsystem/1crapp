...
<!--- New On-Demand Training ---->
    <div class="container">		      
		 <div class="new_ar_tring mt_50p">
            <h2 class="bnt_rundds"><strong>ATTENTION:</strong> working employees. it's now or never.</h2>
			<h3>GET YOUR FIRST (OR NEXT) HIGH TICKET CLIENT IN 30-90 DAYS <span class="red_tx"><u>GUARANTEED!</u></span></h3>
         </div>
	</div>	
         ...
         <div class="v_part_liststs opt_in_pg">		  
		  <div class="bk_pert_sh">
		   <p>
		    ...
		    <span class="sup_al_cntx"><strong>Special Deal</strong> Reserve your coaching application call today to qualify for an additional 90 days of 1:1 coaching at zero cost! </span>
		   </p>
		  </div>
		</div>
    </div>
...
<div class="container">	
 <div class="st_p_cntss">	
  <h3>STEP 1:</h3><p>Reserve your Growth Mapping Session:</p>
 </div>
 ...
 <div class="part_widthss">
  <div class="row">
   <div class="col-lg-6">
    <div class="st_parts_als">
	 <div class="hid_ar_partss">
	  <h2>What is Expected From the Session:</h2>
	 ...
	 <div class="un_boxx">
	  <h4>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce ut elementum elit. Nulla pharetra sem id .</h4>
	  <ul>
   ...
   <div class="col-lg-6">
    <div class="st_parts_als">
	 <div class="hid_ar_partss">
	  <h2 class="red_tx">Book Your Phone Call Now</h2>
	  <div class="arow_downss">
	   <span class="ar_bntss"><i class="fa fa-long-arrow-down"></i></span>
	   <span class="ar_bntss"><i class="fa fa-long-arrow-down"></i></span>
	   <span class="ar_bntss"><i class="fa fa-long-arrow-down"></i></span>
	 ...
	 <div class="tital_main">
	 <div class="un_boxx">
	  <div class="tidycal-embed" data-path="1crapp/1cr-super-realtors"></div>
	 </div>
	 </div>
