...
.al_most_bg .mg_arar.realtorss.mng_images {
    text-align: center;
    height: 100px;
    border-bottom: #61727e solid 1px;
    padding-bottom: 30px;
    display: inline-block;
}
.al_most_bg .mg_arar.realtorss.mng_images img {
    width: auto;
    height: auto;
    margin: 0 auto;
}
        ...
        <div class="row mb_view_none">
            <div class="col-lg-3">
                <div class="al_most_bg">
                    <div class="mg_arar realtorss mng_images">
                        <img src="{{ url('home/img/investors_icons1.png')}}" alt="" />
                    </div>
                    <div class="cnt_al_cntent text-center">
                        <h3>On and Off Market Deals</h3>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                    </div>
					
					<div class="explrr">
					  <a href="javascript:void(0);">Find Deals</a>
					</div>
                </div>
            </div>
			...
			<div class="col-lg-3">
                <div class="al_most_bg">
                    <div class="mg_arar realtorss mng_images">
                        <img src="{{ url('home/img/investors_icons2.png')}}" alt="" />
                    </div>
                    <div class="cnt_al_cntent text-center">
                        <h3>Property Hear Map</h3>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                    </div>
					
					<div class="explrr">
					  <a href="javascript:void(0);">Heat Maps</a>
					</div>
                </div>
            </div>
			...
			<div class="col-lg-3">
                <div class="al_most_bg">
                    <div class="mg_arar realtorss mng_images">
                        <img src="{{ url('home/img/investors_icons3.png')}}" alt="" />
                    </div>
                    <div class="cnt_al_cntent text-center">
                        <h3>Interactive Deal Packes</h3>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                    </div>
					
					<div class="explrr">
					  <a href="javascript:void(0);">Deal Packes</a>
					</div>
                </div>
            </div>
			...
			<div class="col-lg-3">
                <div class="al_most_bg">
                    <div class="mg_arar realtorss mng_images">
                        <img src="{{ url('home/img/investors_icons4.png')}}" alt="" />
                    </div>
                    <div class="cnt_al_cntent text-center">
        ...
        <div class="row mb_view_show realtorss" id="al_mang_tab">
            ...
            <div class="col-lg-12">
                <div class="tab-wrapper">
                    <ul class="tabs">
                        <li class="tab-link active" data-tab="1">On and Off Market Deals</li>
                        <li class="tab-link" data-tab="2">Property Hear Map</li>
                        <li class="tab-link" data-tab="3">Interactive Deal Packes</li>
                        <li class="tab-link" data-tab="4">Tools and Resources</li>
                    </ul>
                </div>
