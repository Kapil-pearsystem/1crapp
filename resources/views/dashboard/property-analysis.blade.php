@php
    $ImprovementCostsData = ImprovementCosts($MainProperty);
    $ExtraChargesData = ExtraChargesPossession($MainProperty);
    $PaidCostData = PaidCostsHelper($MainProperty);
    $conveyanceDeedCost = ConveyanceDeedCost($MainProperty);
    $extraChargeData = ExtraChargesPossession($MainProperty);
    $currency = '₹';
@endphp
										...
										<div class="mn_ulderss" id="dubbal_brodd">
													<div class="unddrlstt last_tlt_parts">
														<h6>
															...
															<!-- End Tolltip -->
															 <span class="cnt_aressss">
															 <span class="managess_cnts">Total Profit</span>
															 <span class="mnss_fldss">=</span></span>
															 <span class="price_lststs pricesss1">₹ -927,447 </span>
														</h6>
													</div>
										</div>
										<!----- End Total Profit ----->
										...
										<div class="mn_ulderss">
											<div class="unddrlstt">
												<h6 class="bluuuue">
													...
													<!-- End Tolltip -->
													<span class="cnt_aressss"><span class="managess_cnts cnt_line_manages">Post -tax Profit</span></span>
													<span class="price_lststs">₹ 649,213 </span>
												</h6>
											</div>
										</div>
										<!--- End Post -tax Profit ---->										
												...
												<div class="accordion-item">
													<div class="unddrlstt accordion-header" id="headingOne">
														<h6>
															...
															<!-- End Tolltip -->
															<span class="cnt_aressss"><span class="managess_cnts">Total Financed Amount </span>
															<i class="fa fa-angle-down accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#refcollapseOnestp1" aria-expanded="true" aria-controls="refcollapseOnestp1"></i>
															</span>
															<span class="price_lststs">Rs. 5400000/-</span>
														</h6>

														<div id="refcollapseOnestp1" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
															<div class="accordion-body">
																<div class="mn_ulderss">
																	<div class="unddrlstt">
																		<h6>
        ...
        <div class="proprt_box_sec bothss full_areaa bh_bs_shteets" id="al_hei_mnges">
            <div class="row" id="margess_bx">
                <div class="col-lg-1">
                    <div class="dibydss_cntss filttere">
                        <div class="table-responsive11" id="both_ar_parts">
                            <div class="vr_t_txtx unr_dr_box"><div class="unddr_cntss">Cash Flow</div></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-11">
					<h3 class="manag_cnt_areaa">Cash Flow (Year 1)
...
<!-- Return & Rations B/F Refinnace (For First Years)  --->
        ...
        <div class="proprt_box_sec bothss full_areaa bh_bs_shteets" id="al_hei_mnges">
            <div class="row" id="margess_bx">
                <div class="col-lg-1">
                    <div class="dibydss_cntss filttere">
                        <div class="table-responsive11" id="both_ar_parts">
                            <div class="vr_t_txtx unr_dr_box"><div class="unddr_cntss">Return & Rations B/F Refinnace (For First Years)</div></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-11">
				    <h3>Return & Rations B/F Refinnace (For First Years)</h3>
					<!------ Holding Cost ----->
                    <div class="row">
                        <div class="col-lg-6">
						   <div class="dibydss_cntss filttere" id="two_boths_prtss">
										...
										<div class="mn_ulderss">
											<div class="unddrlstt">
												<h6>
													...
													<!-- End Tolltip -->
													<span class="cnt_aressss"><span class="managess_cnts">Cap Rate (Market Value)</span></span> <span class="price_lststs">8.0% </span>
												</h6>
											</div>
										</div>
										<!----- End Item Area ----->
										...
										<div class="mn_ulderss">
											<div class="unddrlstt">
												<h6>
													...
													<!-- End Tolltip -->
													<span class="cnt_aressss"><span class="managess_cnts">Equity Multiple:</span></span>
													<span class="price_lststs">5</span>
												</h6>
											</div>
										</div>
										<!----- End Item Area ----->
										...
										<div class="mn_ulderss">
											<div class="unddrlstt">
												<h6>
													...
													<!-- End Tolltip -->
													<span class="cnt_aressss"><span class="managess_cnts">Loan to Cost Ratio </span></span>
													<span class="price_lststs">5</span>
												</h6>
											</div>
										</div>
										...
										<div class="mn_ulderss">
											<div class="unddrlstt">
												<h6>
													...
													<!-- End Tolltip -->
													<span class="cnt_aressss"><span class="managess_cnts">Debt Coverage Ratio</span></span>
													<span class="price_lststs">5</span>
												</h6>
											</div>
										</div>
...
<!-- End Return & Rations B/F Refinnace (For First Years)  --->
