...
.proprt_box_sec.bothss.bh_bs_shteets .dibydss_cntss.filttere .table-responsive11#both_ar_parts .vr_t_txtx .unddr_cntss {left:-27px;}
...
#holding_cst_arae_runningss .proprt_box_sec.bothss .dibydss_cntss.filttere .table-responsive11#both_ar_parts .lists_tablssts.purrssch .mn_ulderss .unddrlstt span.price_lststs.sm_boxx#both_pricess {
    padding: 2px 5px;
    line-height: 21px;
    width: 158px;
}
.proprt_box_sec.bothss .dibydss_cntss.filttere .table-responsive11#both_ar_parts .mn_ulderss.acr_liststst#holding_cost_running .accordion-body#payment_alignss .mn_ulderss .unddrlstt h6 span.tlt_diss_scripss {
    width: 76.5%;
    padding-left: 10px;
}
#purchase_terms_area_prt .proprt_box_sec.bothss .dibydss_cntss.filttere .table-responsive11#both_ar_parts .lists_tablssts .unddrlstt h6 .con-tooltip.top{width:11%;}
#holding_cst_arae_runningss .proprt_box_sec.bothss .dibydss_cntss.filttere .table-responsive11#both_ar_parts .lists_tablssts .unddrlstt h6 .con-tooltip.top{width:11%;}
			   ...
			   <div class="row mb-4">
			    <div class="col-lg-5">
				 <div class="lsting_proprty">
                    <h3>Buy, Refinance & Sale Analysis </h3>
                 </div>
				</div>
			    <div class="col-lg-7">
				 ...
				 <div class="prp_bntsss">
					<ul>
						...
						<li>
							<a href="javascript:void(0);"><i class="fa fa-pie-chart"></i> Buy Refinance & Sale Projection </a>
						</li>
					</ul>
				</div>
				...
				<div class="col-lg-12">
				 <div class="titlss_partss">
				    <p>BUY.RIF. & SELL -> B S Build Tech: A-201 ->  <span class="blk_text">Buy, Refinance & Sale Analysis</span></p>
                    ...
                    <div class="dibydss_cntss filttere">
                        <div class="table-responsive11" id="both_ar_parts">
                            <div class="lists_tablssts purrssch">
								...
								<!----- Item ----->
                                <div class="mn_ulderss blue_araea_bg">
                                    <div class="unddrlstt">
                                        <h6>
                                            <!-- Tolltip -->
                                            <div class="con-tooltip top">
                                ...
                                <div class="mn_ulderss acr_liststst">
                                    <div class="accordion" id="accordionExample">
                                        <div class="accordion-item">
                                            <div class="unddrlstt accordion-header blue_araea_bg" id="headingOne">
                                                <h6>
                                                    <!-- Tolltip -->
                                                    <div class="con-tooltip top">
                                                        <p class="icoo"><i class="fa fa-question"></i></p>
        ...
        <div class="proprt_box_sec bothss full_areaa bh_bs_shteets" id="al_hei_mnges">
            <div class="row" id="margess_bx">
                <div class="col-lg-1">
                    <div class="dibydss_cntss filttere">
                        <div class="table-responsive11" id="both_ar_parts">
                            <div class="vr_t_txtx unr_dr_box"><div class="unddr_cntss">Financing (Purchase)</div></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-11">
        ...
        <div class="proprt_box_sec bothss full_areaa bh_bs_shteets" id="al_hei_mnges">
            <div class="row" id="margess_bx">
                <div class="col-lg-1">
                    <div class="dibydss_cntss filttere">
                        <div class="table-responsive11" id="both_ar_parts">
                            <div class="vr_t_txtx unr_dr_box"><div class="unddr_cntss">Refinancing Loan Data</div></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-11">
				    <h3>Refinancing Loan Data</h3>
					<!------ Holding Cost ----->
                    <div class="row">
                        <div class="col-lg-6">
						   <div class="dibydss_cntss filttere" id="two_boths_prtss">
									...
									<div class="dibydss_cntss filttere">
										<div class="table-responsive11" id="both_ar_parts">
											<div class="lists_tablssts purrssch">									
												...
												<div class="mn_ulderss">
													<div class="unddrlstt">
														<h6>
															...
															<span class="mnss_fldss">+</span>
															<span class="price_lststs">₹18,262</span>
														</h6>
													</div>
												</div>
												<!----- End Taxes ----->
												...
												<div class="mn_ulderss">
													<div class="unddrlstt">
														<h6>
															...
															<span class="mnss_fldss sigma_i">Σ</span>
															<span class="mnss_fldss">+</span>
															<span class="price_lststs">₹22,035</span>
														</h6>
													</div>
												</div>
												...
												<div class="mn_ulderss">
													<div class="unddrlstt">
														<h6>
															...
															<span class="mnss_fldss sigma_i">Σ</span>
															<span class="mnss_fldss">+</span>
															<span class="price_lststs">₹9,181</span>
														</h6>
													</div>
												</div>
												...
												<div class="mn_ulderss">
													<div class="unddrlstt">
														<h6>
															...
															<span class="mnss_fldss sigma_i">Σ</span>
															<span class="mnss_fldss">+</span>
															<span class="price_lststs">₹5,876</span>
														</h6>
													</div>
												</div>
												...
												<div class="mn_ulderss">
													<div class="unddrlstt">
														<h6>
															...
															<!-- End Tolltip -->
															<span class="cnt_aressss"><span class="managess_cnts">Other Charges</span></span>
															<span class="mnss_fldss sigma_i">Σ</span>
															<span class="mnss_fldss">+</span>
															<span class="price_lststs">₹25,707</span>
														</h6>
													</div>
												</div>
												<!----- End Other Charges ----->

												<!----- Operating Cost (Yearly/Monthly) ---->
												<div class="mn_ulderss acr_liststst" id="dubbal_brodd">
													<div class="accordion" id="accordionExample">
														<div class="accordion-item">
															<div class="unddrlstt accordion-header" id="headingOne">
																<h6>
																	...
																	<!-- End Tolltip -->
																	<span class="cnt_aressss" id="mng_space_boxx"><span class="managess_cnts">Operating Cost (Yearly/Monthly)</span> 
																	 <span class="mng_fisetss">
																	  <span class="mnss_fldss plsh">=</span>
																	 </span>
																	</span>
																	<span class="price_lststs last_purchess">₹81,161 </span>
																</h6>
															</div>
														</div>
													</div>
												</div>
												<!----- End Operating Cost (Yearly/Monthly) ---->												
												
												<!----- Extra Debt Paydown ---->
												<div class="mn_ulderss acr_liststst maneg_spaees" id="holding_cost_running">
													<div class="accordion" id="accordionExample">
														<div class="accordion-item">
															<div class="unddrlstt accordion-header" id="headingOne">
																<h6>
																	...
																	<!-- End Tolltip -->
																	<span class="cnt_aressss" id="mng_space_boxx"><span class="managess_cnts">Extra Debt Paydown</span>
																...
																<div id="collapseOneanalist" class="accordion-collapse pricc_lists collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
																	<div class="accordion-body" id="payment_alignss">
																		<div class="mn_ulderss">
																			<div class="unddrlstt">
																				<h6>
												...
												<!----- End Extra Debt Paydown ---->												
												
												<!----- Extra Bank Loan EMI Payment ----->
												<div class="mn_ulderss">
													<div class="unddrlstt">
														<h6>
															<!-- Tolltip -->
															...
															<!-- End Tolltip -->
															<span class="cnt_aressss"><span class="managess_cnts">Bank Loan EMI Payment</span></span>
															<span class="mnss_fldss sigma_i">Σ</span>
															<span class="mnss_fldss">+</span>
															<span class="price_lststs sm_boxx pricesss" id="both_pricess">₹1,084,026 <span class="sm_titlss">30112/Month</span></span>
														</h6>
													</div>
												</div>
												<!----- End Extra Bank Loan EMI Payment ----->
													...
													<div class="unddrlstt last_tlt_parts">
														<h6>
															...
															<!-- End Tolltip -->
															 ...
															 <span class="price_lststs sm_boxx pricesss" id="both_pricess">₹1,315,187 <span class="sm_titlss">32366/Month</span></span>
														</h6>
													</div>
												</div>
  							    	...
  							    	<div class="dibydss_cntss filttere">
										<div class="table-responsive11" id="both_ar_parts">
											<div class="lists_tablssts purrssch">									
												...
												<!----- Current Market Value at the end of 3rd Year ----->
												<div class="mn_ulderss">
													<div class="unddrlstt">
														<h6>
															<!-- Tolltip -->
															...
															<!-- End Tolltip -->
															<span class="cnt_aressss"><span class="managess_cnts">Current Market Value at the end of 3rd Year</span></span>
															<span class="mnss_fldss"></span>
															<span class="price_lststs">₹5,788,125</span>
														</h6>
													</div>
												</div>
												<!----- End Current Market Value at the end of 3rd Year ----->
												...
												<div class="mn_ulderss">
													<div class="unddrlstt">
														<h6>
															...
															<!-- End Tolltip -->
															<span class="cnt_aressss"><span class="managess_cnts">Refinance Amount (x% of CMV i..e 80%)</span></span>
															<span class="mnss_fldss"></span>
															<span class="price_lststs">₹4,630,500</span>
														</h6>
													</div>
												</div>
												<!----- End Refinance Amount ----->
														...
														<div class="accordion-item">
															<div class="unddrlstt accordion-header suprt_alls_pages" id="headingOne">
																<h6>
																	...
																	<!-- End Tolltip -->
																	<span class="cnt_aressss">
																	 <span class="managess_cnts">Admin & Insurance -PMI </span> <i class="fa fa-angle-down accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne2" aria-expanded="true" aria-controls="collapseOne2"></i> <span class="mnss_fldss plsh">-</span>
																	 </span>
												...
												<!----- End Admin & Insurance -PMI ---->
												
											
												<!----- Bank Purchase Loan Replayment ----->
												<div class="mn_ulderss">
													<div class="unddrlstt suprt_alls_pages1">
														<h6>
															<!-- Tolltip -->
															<div class="con-tooltip top">
																<p class="icoo"><i class="fa fa-question"></i></p>
															...
															<!-- End Tolltip -->
															<span class="cnt_aressss"><span class="managess_cnts">Bank Purchase Loan Replayment</span></span>
															<span class="mnss_fldss">-</span>
															<span class="price_lststs">₹3,661,634</span>
														</h6>
													</div>
												</div>
												<!----- End Bank Purchase Loan Replayment ----->
												...
												<div class="mn_ulderss">
															<div class="unddrlstt">
																<h6>
																	...
																	<!-- End Tolltip -->
																	<span class="cnt_aressss"><span class="managess_cnts">Holding cost for <span class="red">XX</span> Month</span></span> 
																	 <span class="mng_fisetss">
																	  <span class="mnss_fldss plsh">-</span>
																	 </span>
																	
																	<span class="price_lststs">₹1,285,636</span>
																</h6>
															</div>														
												</div>
												<!----- End Operating Cost (Yearly/Monthly) ---->
												...
												<!----- Gross Cash Needed / Invested (Purchase Time) ---->
												<div class="mn_ulderss">
															<div class="unddrlstt">
																<h6>
																	<!-- Tolltip -->
																	...
																	<!-- End Tolltip -->
																	<span class="cnt_aressss"><span class="managess_cnts">Gross Cash Needed / Invested (Purchase Time)</span> </span>
																	 <span class="mng_fisetss">
																	  <span class="mnss_fldss plsh">-</span>
																	 </span>
												...
												<!----- End Gross Cash Needed / Invested (Purchase Time) ---->
												
												
												<!---- Net Invested Amount on FRF/LAE ---->
												<div class="mn_ulderss">
													<div class="unddrlstt">
														<h6>
															<!-- Tolltip -->
															...
															<!-- End Tolltip -->
															 <span class="cnt_aressss"><span class="managess_cnts">Net Invested Amount on FRF/LAE(+/-)</span></span>
															 <span class="mnss_fldss">=</span>
															 <span class="price_lststs sm_boxx pricesss" id="both_pricess">₹2,139,380 <span class="sm_titlss">Surplus Cashout Amount</span></span>
														</h6>
													</div>
												</div>
												<!---- End Net Invested Amount on FRF/LAE ---->
											</div>
										</div>
									</div>
													...
													<div class="unddrlstt last_tlt_parts">
														<h6>
															...
															<!-- End Tolltip -->
															 ...
															 <span class="price_lststs red pricesss1">₹ -927,447 </span>
														</h6>
													</div>
										</div>
										<!----- End Total Profit ----->
										...
										<div class="mn_ulderss">
											<div class="unddrlstt">
												<h6 class="bluuuue">
													...
													<!-- End Tolltip -->
													<span class="cnt_aressss"><span class="managess_cnts cnt_line_manages tx_black">Post -tax Profit</span></span>
                                        ...
                                        <div class="mn_ulderss">
                                            <div class="unddrlstt">
                                                <h6 id="singallls">
                                                    ...
                                                    <!-- End Tolltip -->
                                                    <span class="cnt_aressss bor_none"><span class="managess_cnts">Annualized ROI: </span></span>
