        ...
        <div class="col-md-8">
            <div class="form-group managsss1">
                ...
                <div class="pce_percent" <?php if(count($itemRefinanceCost)==0){ }else{ echo 'style="display: none;"';} ?>>
                    ...
                    <span class="pursntss">% Of Refinanced Amount</span>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="choss_araes">
                ...
                <div class="yesNoButton" style=" width: 100%;">
                    <input type="checkbox" @if(count($itemRefinanceCost)) checked @endif class="toggle" id="toggle13" autocomplete="off" name="refinaceCostitemizedToggle"/>
                    <label for="toggle13">
