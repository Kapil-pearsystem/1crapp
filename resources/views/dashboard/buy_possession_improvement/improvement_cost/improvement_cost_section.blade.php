...
<div class="all_frm_list">
    <div class="form-group managsss1">
        ...
        <div class="both_areaa">
            <div class="lft_araeassd" style="width: 80%;">
                <input type="text" placeholder="Total Improvement Cost" id="totalImprovementCostPInput" value="<?=$MainProperty->prop_improvementCostPercent?>" name="totalImprovementCostPInput" autocomplete=off <?php if(count($ItemImprovementCost['Data'])){ ?> readonly <?php } ?>/>
                <span class="pursntss">% Of Price</span>
            </div>
            <div class="ri_lft_araeassd" style="width: 20%;margin-top: -25px;">
                <label>Itemize:</label>
                <div class="yesNoButton">
                    <input type="checkbox" class="toggle" id="toggle2" autocomplete="off" <?php if(count($ItemImprovementCost['Data'])){ echo "checked";} ?> name="improvementCostitemizedToggle"/>
                    <label for="toggle2">
    ...
    <div class="itm_cost_prch" id="itemisedImprovementCost" <?php if(!count($ItemImprovementCost['Data'])){ echo 'style="display: none;"';} ?>>
        <div class="hd_res_listsss">
            <h2>
                <span class="rit_mg">
