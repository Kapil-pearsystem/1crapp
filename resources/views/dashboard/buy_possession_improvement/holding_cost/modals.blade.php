        ...
        <div class="modal-content all_frm_list">
            ...
            <form id="itemizedHoldingCostForm" method="POST">
                ...
                <div class="hd_res_listsss">
                    <h2>Add Holding Cost (per month)</h2>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content all_frm_list">
            ...
            <form id="itemizedHoldingCostFormEdit" method="POST">
                ...
                <div class="hd_res_listsss">
                    <h2>Edit Holding Cost (per month)</h2>
                </div>
                <div class="form-group">
                    <label>Name </label>
                    <input type="text" name="itemizedPaidAmtName" id="itemizedHoldingCostNameEdit" placeholder="Name" value="" required/>
                </div>
                <div class="tbss_form_lst mt-4">
                    <div class="tab-wrapper">
                        <div class="tbs_hids">Type</div>
                    ...
                    <div class="content-wrapper">
                        <div id="tabHoldingCost-amountEdit" class="tab-content active">							
                            <div class="form-group managsss1">
                                <label>Amount </label>
                                <span class="currencyInputprefix"><?=$currency?></span>
                                <input name="itemizedPaidAmtAmount" id="itemizedHoldingCostAmountEdit" class="currencyInput validateFloatInput" type="text" placeholder="Amount" value="" />
                            </div>
                        </div>
                        <div id="tabHoldingCost-percentEdit" class="tab-content">							
                            <div class="form-group managsss1">
                                <label>Percent </label>
                                <input type="text" name="itemizedPaidAmtPercent" id="itemizedHoldingCostPercentEdit" placeholder="Percent" value="" class="validateFloatInput" />
                        ...
                        <div class="form-group managsss1">
                            <label>Date</label>
                            <input name="itemizedPaidAmtDate" id="itemizedHoldingCostDateEdit" type="date" placeholder="DD MM YYYY" value="" class="" required/>
                        </div>    
                        <div class="form-group managsss1">
                            <div class="roll_lst">
                                <div class="lft_raea">
