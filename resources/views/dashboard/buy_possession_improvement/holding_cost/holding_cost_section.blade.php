<div class="hd_res_listsss">
    <h2>Holding Cost (per month)<span class="ticck" tooltip="Data Coming Soon" flow="down">?</span></h2>
</div>
...
<div class="all_frm_list">
    <div class="form-group managsss1">
        ...
        <div class="both_areaa">
            <div class="lft_araeassd" style="width: 80%;">
                ...
                <span class="pursntss">% Of Price / Month</span>
            </div>
            <div class="ri_lft_araeassd" style="width: 20%;margin-top: -25px;">
                <label>Itemize:</label>
                <div class="yesNoButton">
                    <input type="checkbox" class="toggle" id="toggle4" autocomplete="off" <?php if(count($ItemHoldingCost["Data"])){ echo "checked";} ?> name="holdingCostitemizedToggle"/>
                    <label for="toggle4">
    ...
    <div class="itm_cost_prch" id="itemisedHoldingCost" <?php if(!count($ItemHoldingCost["Data"])){ echo 'style="display: none;"';} ?>>
        <div class="hd_res_listsss">
            <h2>
                <span class="rit_mg">
