...

{
    ...
    public function add(){
        ...
        $page =PageModel::select('page_name','id')->get();

        return view('page/add',compact('tags','lists','assets'));
...

    {
        ...
        $page->page_cta_url = $page_cta_url;

        $page->other_page_cta_url_status = $other_page_cta_url_status;
...

    {
        ...
        return view('page/add',compact('tags','lists','details','assets'));
