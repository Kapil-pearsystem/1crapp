...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Product & Services Category </h1>
            <div class="row">
                <div class="col-md-12">
				    <a href="{{ route('productservices.addcategory') }}" class="btn btn-sm btn-primary"><i aria-hidden="true" class="fas fa-plus"></i> Add Category</a>
                ...
                <div class="table-responsive swich_bntts">
                    <table class="table table-bordered" id="example-table-theme" width="100%" cellspacing="0">
						...
						<tr>
							...
							<td>
								<a href="{{ route('productservices.editcategory',[$list->id]) }}" class="btn btn-primary bnt_alsss"><i aria-hidden="true" class="fa fa-pen"></i></a>
								<a class="btn btn-danger m-2 deleteBtn" 
                                   href="#" 
                                   data-url="{{ route('productservices.deletecategory', $list->id) }}"
                                   data-toggle="modal" 
