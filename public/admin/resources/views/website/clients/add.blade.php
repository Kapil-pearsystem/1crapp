@extends('layouts.app')
@section('title', isset($details) ? 'Edit Our Clients' : 'Add Our Clients')
@section('content')
<div class="container-fluid">
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ isset($details) ? 'Edit' : 'Add' }} Our Clients</h1>
        <a href="{{ route('web.clients.index') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-arrow-left fa-sm text-white-50"></i> Back</a>
    </div>
    {{-- Alert Messages --}}
    ...
    <form method="POST" action="{{ route('web.client.store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="card-footer">
            ...
            <a class="btn btn-primary float-right mr-3 mb-3" href="{{ route('web.clients.index') }}">Cancel</a>
        </div>
    </form>
