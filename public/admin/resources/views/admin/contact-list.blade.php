...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div class="row">
                <div class="col-md-12">
				    <a href="{{ route('lists.create') }}" class="btn btn-sm btn-primary"><i aria-hidden="true" class="fas fa-plus"></i> Add New List</a>
                </div>
            </div>
        </div>
      ...
      <!--                      </label>-->
						...
						<tr>
                            ...
                            <select class="form-control form-control-sm">
                                <option>Add from Existing</option>
                                <option>Add from Externally</option>
                            </select>
                            </td>
							<td>
                            <label class="switch">
...
<script>
    $(document).ready(function () {
        $('.status-toggle').on('change', function () {
            ...
            $.ajax({
                url: '{{ route('lists.update-status') }}', // Define the correct route
                type: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    id: contactId,
