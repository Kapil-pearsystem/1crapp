...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="row">
            <div class="col-md-12">
                <a href="{{ route('booking-calender.create') }}" class="btn btn-sm btn-primary">
                ...
                <table class="table table-bordered" id="booking-calender-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- Edit -->
                                <a href="{{ route('booking-calender.edit', $item->id) }}"
                                ...
                                <a href="#" class="btn btn-danger btn-sm"
                                   onclick="if(confirm('Are you sure?')) {
                                       window.location.href='{{ route('booking-calender.delete', $item->id) }}';
                                   }">
