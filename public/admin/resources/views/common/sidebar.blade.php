...
@endif
     ...
     <div id="D_databes" aria-labelledby="headingTwo" data-parent="#accordionSidebar" class="collapse">
        <div class="collapse-inner">
		  <div class="accordion_container">
			...
			<?php if(!Auth()->user()->hasrole('Agent')){ ?>
			<div class="man_boxx">
				<div class="accordion_head"><i class="fas fa-users"></i> End Users <span class="plusminus">+</span></div>
				<div class="accordion_body" style="display: none;">
				 <div class="user_listst_links">
				   <ul>
    ...
    <li class="nav-item active">
            ...
            <div id="MD_Foundation" aria-labelledby="headingTwo" data-parent="#accordionSidebar" class="collapse">
                <div class="collapse-inner">
                    <div class="accordion_container">

                        <div class="man_boxx">
                            <div class="accordion_head"><i class="fas fa-users"></i>Membership Request<span class="plusminus">+</span></div>
                            <div class="accordion_body" style="display: none;">
                                <div class="user_listst_links">
                                    <ul>
                        ...
                        <div class="man_boxx">
                            <div class="accordion_head"><i class="fas fa-money"></i>Crowd Funding<span class="plusminus">+</span></div>
                            <div class="accordion_body" style="display: none;">
                                <div class="user_listst_links">
                                    <ul>
                                        <li><a href="javascript:void(0);"> List</a></li>
                        ...
                        <div class="man_boxx">
                            <div class="accordion_head"><i class="fas fa-circle"></i>Certificate Management<span class="plusminus">+</span></div>
                            <div class="accordion_body" style="display: none;">
                                <div class="user_listst_links">
                                    <ul>
                                        <li><a href="javascript:void(0);"> List</a></li>
                        ...
                        <div class="man_boxx">
                            <div class="accordion_head"><i class="fas fa-circle"></i>Beneficiary Management<span class="plusminus">+</span></div>
                            <div class="accordion_body" style="display: none;">
                                <div class="user_listst_links">
                                    <ul>
                                        <li><a href="javascript:void(0);"> List</a></li>
                        ...
                        <div class="man_boxx">
                            <div class="accordion_head"><i class="fas fa-list"></i>Internship Management<span class="plusminus">+</span></div>
                            <div class="accordion_body" style="display: none;">
                                <div class="user_listst_links">
                                    <ul>
                                        <li><a href="javascript:void(0);"> List</a></li>
                        ...
                        <div class="man_boxx">
                            <div class="accordion_head"><i class="fas fa-calendar"></i>Event Management<span class="plusminus">+</span></div>
                            <div class="accordion_body" style="display: none;">
                                <div class="user_listst_links">
                                    <ul>
                                        <li><a href="javascript:void(0);"> List</a></li>
                        ...
                        <div class="man_boxx">
                            <div class="accordion_head"><i class="fas fa-calendar"></i>Activity Management<span class="plusminus">+</span></div>
                            <div class="accordion_body" style="display: none;">
                                <div class="user_listst_links">
                                    <ul>
                                        <li><a href="javascript:void(0);"> List</a></li>
                        ...
                        <div class="man_boxx">
                            <div class="accordion_head"><i class="fas fa-list"></i>Project Management<span class="plusminus">+</span></div>
                            <div class="accordion_body" style="display: none;">
                                <div class="user_listst_links">
                                    <ul>
                                        <li><a href="javascript:void(0);"> List</a></li>
                        ...
                        <div class="man_boxx">
                            <div class="accordion_head"><i class="fas fa-cog"></i>Expense Management<span class="plusminus">+</span></div>
                            <div class="accordion_body" style="display: none;">
                                <div class="user_listst_links">
                                    <ul>
                                        <li><a href="javascript:void(0);"> List</a></li>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#birthdayDropDown"
            aria-expanded="true" aria-controls="birthdayDropDown">
            <i class="fas fa-calendar"></i>
            <span>Birthday Wishes</span>
        </a>
        <div id="birthdayDropDown" class="collapse" aria-labelledby="headingTwo" data-parent="#birthdayDropDown">
            <div class="bg-white py-2 collapse-inner rounded">
				...
				<div class="accordion_body" style="display: none;">
				 <div class="user_listst_links">
				   <ul>
					...
					<li><a href="{{ route('web.services.index') }}"> Services & Category</a></li>
