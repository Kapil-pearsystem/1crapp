...
<div class="container-fluid"><div class="al_bx_mng_araea">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ Auth()->user()->hasrole('Agent') ? 'Agent Profile' : 'Edit Agent' }}</h1>
        <a href="{{ route('users.index') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i aria-hidden="true" class="fas fa-arrow-left fa-sm text-white-50"></i> Back</a>
    </div>
    ...
    <div class="card shadow mb-4 bg_sky_clr">
        <div class="card-header py-3 bg_sky_clr">
            <h6 class="m-0 font-weight-bold text-primary">Edit Agent Information</h6>
            @if($errors->any())
                <div>
        ...
        <form method="POST" action="{{ route('users.update-agent-details') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        Agent Package
                        <select class="form-control form-control-user" name="package" id="package">
                            <option value="">Select Package</option>
                            @foreach(\App\Models\SubscriptionPlan::where('status',1)->get() as $plan)
                                <option value="{{ $plan->id }}" <?php if(isset($agentdata->package) && $agentdata->package == $plan->id){ echo 'selected'; } ?>>{{ $plan->title }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">Tags</label>
                        <select class="form-control form-control-user" name="tag_id" id="tag_id">
                            ...
                            @foreach($tags as $tag)
                                <option value="{{ $tag->id }}" <?php if($userdata->tag_id == $tag->id){ echo 'selected'; } ?>>{{ $tag->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">List</label>
                        <select class="form-control form-control-user" name="contact_id" id="contact_id">
                            ...
                            @foreach($contacts as $contact)
                                <option value="{{ $contact->id }}" <?php if($userdata->contact_id == $contact->id){ echo 'selected'; } ?>>{{ $contact->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        No of children 1
                            ...
                            <select class="form-control form-control-user" name="numberofchild" id="no_of_childrens" >
                                <option value="">Select</option>
                                <option value="1" <?php if(isset($agentdata->numberofchild) && $agentdata->numberofchild == 1){ echo 'selected'; }?>>1</option>
                                <option value="2" <?php if(isset($agentdata->numberofchild) && $agentdata->numberofchild == 2){ echo 'selected'; }?>>2</option>
                                <option value="3" <?php if(isset($agentdata->numberofchild) && $agentdata->numberofchild == 3){ echo 'selected'; }?>>3</option>
                                <option value="4" <?php if(isset($agentdata->numberofchild) && $agentdata->numberofchild == 4){ echo 'selected'; }?>>4</option>
                                <option value="5" <?php if(isset($agentdata->numberofchild) && $agentdata->numberofchild == 5){ echo 'selected'; }?>>5</option>
                                <option value="6" <?php if(isset($agentdata->numberofchild) && $agentdata->numberofchild == 6){ echo 'selected'; }?>>6</option>
                                <option value="7" <?php if(isset($agentdata->numberofchild) && $agentdata->numberofchild == 7){ echo 'selected'; }?>>7</option>
                                <option value="8" <?php if(isset($agentdata->numberofchild) && $agentdata->numberofchild == 8){ echo 'selected'; }?>>8</option>
                                <option value="9" <?php if(isset($agentdata->numberofchild) && $agentdata->numberofchild == 9){ echo 'selected'; }?>>9</option>
                            </select>
                    </div>
            ...
            <div class="card-footer text-center bg_sky_clr border_none">
                <button type="submit" class="btn btn-primary btn-user mb-3 btn_bg_same">{{ Auth()->user()->hasrole('Agent') ? 'Save Personal Details' : 'Save Agent Details' }}</button>
            </div>
        </form>
    </div>
    ...
    <div class="card shadow mb-4 bg_sky_clr"  id="company-section">
        ...
        <form method="POST" action="{{ route('users.update-agent-company') }}" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="user_id" value="{{ @$userdata->id }}">
            <div class="card-body">
                <div class="form-group row">
    ...
    <div class="card shadow mb-4 bg_sky_clr" id="password-section">
        ...
        <form method="POST" action="{{ route('users.update-agent-password') }}">
            @csrf
            <input type="hidden" name="user_id" value="{{ @$userdata->id }}">
            <div class="card-body">
                <div class="form-group row">
    ...
    <div class="card shadow mb-4 bg_sky_clr">
        ...
        <form method="POST" action="{{ route('users.update-agent-social-networks') }}">
            @csrf
            <input type="hidden" name="user_id" value="{{ @$userdata->id }}">
            <div class="card-body">
                <div class="form-group row">
