...
<div class="container-fluid"><div class="al_bx_mng_araea">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        <span style="color: red;">*</span>Agent ID
                        <input type="text" id="username" placeholder="Agent ID" name="username" value="{{ @$agentdata->username }}" class="form-control form-control-user" onkeyup="javascript:checkUserName()" required="" />
                        <small id="user_msg"></small>
                    </div>

                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        <span style="color: red;">*</span>Agent Email
                        <input type="text" id="email" placeholder="Agent Email" name="email" value="{{ @$userdata->email}}" class="form-control form-control-user" required="" />
                    </div>

                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        Agent Package
                        <input type="text" id="package" placeholder="Agent Package" name="package" value="{{ \App\Models\SubscriptionPlan::where(['status'=>1])->first()->title??'' }}" class="form-control form-control-user" readonly />
                    </div>

                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        <span style="color: red;">*</span>Fist Name
                        <input type="text" id="first_name" placeholder="Fist Name" name="first_name" value="{{ @$userdata->first_name}}" class="form-control form-control-user" required="" />
                    </div>

                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        Middle Name
                        <input type="text" id="middle_name" placeholder="Middle Name" name="middle_name" value="{{ @$userdata->middle_name}}" class="form-control form-control-user" />
                    </div>

                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        <span style="color: red;">*</span>Last Name
                        <input type="text" id="last_name" placeholder="Last Name" name="last_name" value="{{ @$userdata->last_name}}" required="required" class="form-control form-control-user"/>
                    </div>
                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        <span style="color: red;">*</span> Phone
                        <input type="text" id="mobile_code" placeholder="Phone" name="mobile_number" value="{{ @$userdata->mobile_number }}" required="required" class="form-control form-control-user" />
                    </div>
                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        Official Email
                        <input type="text" id="official_email" placeholder="Official Email" name="official_email" value="{{ @$agentdata->official_email}}" class="form-control form-control-user" />
                    </div>
                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        Personal Website
                        <input type="text" id="personal_website" placeholder="Personal Website" name="personal_website" value="{{ @$agentdata->personal_website}}" class="form-control form-control-user" />
                    </div>
                    <div class="col-lg-12">
                        <div class="copy_btnns">
                    ...
                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        Fist Name
                        <input type="text" id="first_name2" placeholder="Fist Name"  value="{{ @$userdata->first_name}}" readonly class="form-control form-control-user" />
                    </div>

                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        Middle Name
                        <input type="text" id="middle_name2" placeholder="Middle Name"  value="{{ @$userdata->middle_name}}" readonly class="form-control form-control-user" />
                    </div>

                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        Last Name
                        <input type="text" id="last_name2" placeholder="Last Name"  value="{{ @$userdata->last_name}}" readonly class="form-control form-control-user"/>
                    </div>
                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        <label>Country</label>
                    ...
                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        ...
                        <input type="text" id="address" placeholder="User Address" name="address" value="{{ @$agentdata->address}}"  class="form-control form-control-user" />
                    </div>
                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        ZIP Postal Code:
                        <input type="text" id="zip" placeholder="User Address" name="zip" value="{{ @$agentdata->zip}}"  class="form-control form-control-user" />
                    </div>
                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        <span style="color: red;">*</span> Phone
                        <input type="text" id="phone" placeholder="Phone" name="phone" value="{{ @$agentdata->phone }}" required="required" class="form-control form-control-user" />
                    </div>
                    <!-- <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        Work
                ...
                <div class="form-group row"  id="dob-section">
                    ...
                    <div class="col-sm-3 mb-3 mt-3 mb-sm-0">
                        Self
                        <input type="date" id="dob" placeholder="Self" name="self_dob" value="{{ @$agentdata->self_dob}}"  class="form-control form-control-user" />
                    </div>

                    <div class="col-sm-3 mb-3 mt-3 mb-sm-0">
                        Spouse
                        <input type="date" id="spouse_dob" placeholder="Spouse" name="spouce_dob" value="{{ @$agentdata->spouce_dob}}" class="form-control form-control-user" />
                    </div>

                    <div class="col-sm-3 mb-3 mt-3 mb-sm-0">
                        Anniversary
                        <input type="date" id="anniversary" placeholder="Anniversary" name="anniversary_date" value="{{ @$agentdata->anniversary_date}}" class="form-control form-control-user" />
                    </div>
                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        Working in
                        <select name="working_in" class="form-control form-control-user" id="worked_in" >
							<option value="Indian oil corporetion" selected="selected">Indian oil corporetion</option>
						</select>
                    </div>
                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        No of children
                          <?php
                            if(isset($agentdata)){
                                $no_of_childrens = $agentdata->numberofchild;
                            }else{
                                $no_of_childrens = 0;
                            }
                          ?>
                            <select class="form-control form-control-user" name="numberofchild" id="no_of_childrens" >
                                <option value="">Select</option>
                                <option value="1" <?php if($no_of_childrens == 1){ echo 'selected'; }?>>1</option>
                                <option value="2" <?php if($no_of_childrens == 2){ echo 'selected'; }?>>2</option>
                                <option value="3" <?php if($no_of_childrens == 3){ echo 'selected'; }?>>3</option>
                                <option value="4" <?php if($no_of_childrens == 4){ echo 'selected'; }?>>4</option>
                                <option value="5" <?php if($no_of_childrens == 5){ echo 'selected'; }?>>5</option>
                                <option value="6" <?php if($no_of_childrens == 6){ echo 'selected'; }?>>6</option>
                                <option value="7" <?php if($no_of_childrens == 7){ echo 'selected'; }?>>7</option>
                                <option value="8" <?php if($no_of_childrens == 8){ echo 'selected'; }?>>8</option>
                                <option value="9" <?php if($no_of_childrens == 9){ echo 'selected'; }?>>9</option>
                            </select>
                    </div>
                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0 upldds">
                        <span style="color: red;">*</span>Profile Picture
                        <input type="file" id="" placeholder="File Upload" name="profile_pic" value="" class="form-control form-control-user" />
                    </div>                    <div class="col-sm-12 mt-5 mb-sm-0 pt-0 upldds text-center">
                        <img src="{{ url('').'/profile/'.$userdata->profile_pic }}" class="img-profile" width="50px">
    ...
    <div class="card shadow mb-4 bg_sky_clr"  id="company-section">
        ...
        <form method="POST" action="{{ route('myaccount.updateCompany') }}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="form-group row">
                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        <span style="color: red;">*</span>Company Name
                        <input type="text" id="" placeholder="Company Name" name="company_name" value="{{ @$company->company_name}}" class="form-control form-control-user" required="" />
                    </div>
                    ...
                    <div class="col-sm-8 mb-3 mt-3 mb-sm-0">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-7 mb-3 mb-sm-0">
                                <input type="text" id="" placeholder="Company Email" name="company_email" value="{{ @$company->company_email}}" class="form-control form-control-user" required="" />
                            </div>
                    ...
                    <div class="col-sm-8 mb-3 mt-3 mb-sm-0">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-7 mb-3 mb-sm-0">
                                <input type="text" id="" placeholder="Company Phone" name="company_phone" value="{{ @$company->company_phone}}" class="form-control form-control-user"  />
                            </div>
                            <div class="col-sm-5 mb-3 mb-sm-0">
                    ...
                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        Company Address
                        <input type="text" id="" placeholder="Company Address" name="company_address" value="{{ @$company->company_address}}" class="form-control form-control-user"  />
                    </div>

                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        Company Website
                        <input type="text" id="" placeholder="Company Website" name="company_website" value="{{ @$company->company_website}}" class="form-control form-control-user"/>
                    </div>

                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0 upldds">
                        Company Logo
                        <input type="hidden" name="old_company_logo" value="{{ @$company->company_logo }}"/>
    ...
    <div class="card shadow mb-4 bg_sky_clr">
        ...
        <form method="POST" action="{{ route('myaccount.updateAccounts') }}">
            @csrf
            <div class="card-body">
                <div class="form-group row">
                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        ...
                        <input type="text" id="" placeholder="Facebook" name="facebook_acc" value="{{ @$company->facebook_acc}}" class="form-control form-control-user"  />
                    </div>
                    ...
                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        ...
                        <input type="text" id="" placeholder="Youtube" name="youtube_acc" value="{{ @$company->youtube_acc}}" class="form-control form-control-user" />
                    </div>
                    ...
                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        ...
                        <input type="text" id="" placeholder="LinkedIn" name="linkedin_acc" value="{{ @$company->linkedin_acc}}" class="form-control form-control-user" />
                    </div>
                    ...
                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        ...
                        <input type="text" id="" placeholder="Twitter" name="twiter_acc" value="{{ @$company->twiter_acc}}" class="form-control form-control-user" />
                    </div>
                    ...
                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        ...
                        <input type="text" id="" placeholder="Telegram" name="telegram_acc" value="{{ @$company->telegram_acc}}" class="form-control form-control-user" />
                    </div>
                    ...
                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        ...
                        <input type="text" id="" placeholder="Skype" name="skype_acc" value="{{ @$company->skype_acc}}" class="form-control form-control-user" />
                    </div>
                    ...
                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        ...
                        <input type="text" id="" placeholder="Instagram " name="instagram_acc" value="{{ @$company->instagram_acc}}" class="form-control form-control-user" />
                    </div>

                    <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                        <span style="color: red;">&nbsp;</span>Any Other
                        <input type="text" id="" placeholder="Enter Other Social link" name="other_acc" value="{{ @$company->other_acc}}" class="form-control form-control-user"  />
                    </div>
                </div>
            </div>
            <div class="card-footer text-center bg_sky_clr border_none">
                ...
                <div class="binng_araes earn_area">
                    <div class="earn_bx">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="earn_bxx">
                                    <img src="https://1crapp.allproject.online/home/img/join_bx.png" alt="">
                                    <span class="cntss_araea">Join</span>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="earn_bxx">
                                    <img src="https://1crapp.allproject.online/home/img/promote_bx.png" alt="">
                                    <span class="cntss_araea">Promote</span>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="earn_bxx">
                                    <img src="https://1crapp.allproject.online/home/img/earn_bx.png" alt="">
                    ...
                    <div class="share_araea">
                        <h4>Invite Friends and Earn Rewards Instantly!</h4>
                        <ul>
                            <li>
                                <a href="https://www.facebook.com/sharer/sharer.php?u={{ route('users.create').'?referral='.$userdata->referral_code }}" target="_blank">
                                    <img src="https://1crapp.allproject.online/home/img/facebook.png" alt="Facebook">
                                </a>
                            </li>
                            <li>
                                <a href="https://www.linkedin.com/sharing/share-offsite/?url={{ route('users.create').'?referral='.$userdata->referral_code }}" target="_blank">
                                    <img src="https://1crapp.allproject.online/home/img/instagram.png" alt="LinkedIn">
                                </a>
                            </li>
                            <li>
                                <a href="https://twitter.com/intent/tweet?url={{ route('users.create').'?referral='.$userdata->referral_code }}&text=Join+now+with+this+referral+link!" target="_blank">
                                    <img src="https://1crapp.allproject.online/home/img/twitter.png" alt="Twitter">
                                </a>
                            </li>
                            <li>
                                <a href="https://api.whatsapp.com/send?text={{ route('users.create').'?referral='.$userdata->referral_code }}" target="_blank">
                                    <img src="https://1crapp.allproject.online/home/img/what-up.png" alt="WhatsApp">
                                </a>
                            </li>
                            <li>
                                <a href="mailto:?subject=Join+now!&body=Join+now+with+this+referral+link:+{{ route('users.create').'?referral='.$userdata->referral_code }}">
                                    <img src="https://1crapp.allproject.online/home/img/messanger.png" alt="Email">
                                </a>
                            </li>
                            <!-- <li>
                                <a href="#">
                                    <img src="https://1crapp.allproject.online/home/img/instagram.jpeg" alt="Email">
                                </a>
                            </li> -->
                        </ul>
                        <div class="shr_linkss al_qusess_topup mb-4">
                            <input type="text" class="" placeholder="" id="referral_link" readonly value="{{ route('users.create').'?referral='.$userdata->referral_code }}">
                            <button type="button" value="submit" id="copyButton" onclick="copyReferralLink()">Copy &amp; share </button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    function checkUserName() {
        ...
        if(usrlnth < 4) {
            $('#user_msg').text('Agent ID must be at least 4 characters long.').css('color', 'red');
        } else {
            $.ajax({
                url: '{{ route("myaccount.checkusername") }}',
                type: "POST",
                data: {
                    username: username,
                ...
                success: function(response) {
                    if(response.status === true) {
                        $('#user_msg').text('Agent ID  is available.').css('color', 'green');
                    } else if(response.status === false) {
                        $('#user_msg').text('Agent ID  already in use.').css('color', 'red');
                    } else {
                        $('#user_msg').text('Agent ID does not exist.').css('color', 'red');
                    }
                },
...
<?php
$country = isset($agentdata->country) ? $agentdata->country : '';
$state = isset($agentdata->state) ? $agentdata->state : '';
$city = isset($agentdata->city) ? $agentdata->city : '';
