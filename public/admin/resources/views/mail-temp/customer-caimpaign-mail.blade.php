    ...
    <div class="email-container">
        <div class="email-content">
            ...
            <div class="email-header">
                ...
                @if($data['logo'])
                    <img src="{{ $data['logo'] }}" alt="1CR Logo">
                @else
            ...
            <div class="email-body">
                ...
                @if(!is_null($data) && !is_null($data['mail']))
                    ...
                    @if($data['mail']->cta_visible == 1)
                        ...
                        <div class="cta-btn-container text-light">
                            <a href="{{ $data['mail']->cta_link }}" class="cta-btn" style="color:white;" target="_blank">{{ $data['mail']->cta_title }}</a>
                        </div>
                    @endif
