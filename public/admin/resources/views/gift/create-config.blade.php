@extends('layouts.app')
@section('title', isset($details) ? 'Edit Gift Config' : 'Add Gift Config')
@section('content')
<div class="container-fluid">
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ isset($details) ? 'Edit' : 'Add' }} Gift Config</h1>
    ...
    <div class="card shadow mb-4">
        <form method="POST" action="{{ route('gift.config.store') }}">
            @csrf
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0 {{ isset($details) ? 'disable-section' : '' }}" >
                        <label><span style="color: red;">*</span> Key</label>
                        <input type="text" name="key" value="{{ old('key') ?? ($details->key ?? '') }}" required class="form-control form-control-user" />
                    </div>
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
